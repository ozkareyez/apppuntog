...
import ProductoDetallado from "./pages/ProductoDetalladoNuevo";
    ...
    <>
      ...
      <Routes>
        ...
        <Route element={<PublicLayout />}>
          ...
          {/* 🔴 CAMBIO 1: Ruta de producto usa :slug en lugar de :id */}
          <Route path="/productos/:slug" element={<ProductoDetallado />} />
