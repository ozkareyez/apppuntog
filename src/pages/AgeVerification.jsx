  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Card principal - SIN sombras rosadas */}
          <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden">
            {/* Encabezado rojo profesional */}
            ...
            <div className="p-5">
              ...
              <div className="text-center mb-4">
                ...
                <div className="inline-flex items-center gap-1.5 px-2 py-1.5 bg-red-50 rounded-lg">
              ...
              <div className="space-y-2">
                <motion.button
                  ...
                  disabled={isLoading}
                  className="w-full py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 rounded-lg font-bold text-white transition-all duration-300 flex items-center justify-center gap-2 text-sm shadow-md hover:shadow-lg"
                  style={{
                    boxShadow:
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={handleDeny}
                  className="w-full py-3 rounded-lg font-bold text-gray-700 border border-gray-300 hover:border-red-400 hover:text-red-600 hover:bg-red-50/50 transition-all duration-300 flex items-center justify-center gap-2 text-sm"
                >
              ...
              >
                <p className="text-[10px] text-gray-400 text-center leading-relaxed">
                  ...
                  requerida. El acceso a menores está prohibido.
                </p>
              </motion.div>
            </div>
          </div>

          {/* Elementos decorativos - TOTALMENTE NEUTROS */}
          <div className="absolute -z-10 -inset-4">
            <div className="absolute top-10 left-10 w-24 h-24 bg-neutral-900/5 rounded-full blur-2xl" />
            <div className="absolute bottom-10 right-10 w-32 h-32 bg-black/5 rounded-full blur-2xl" />
          </div>
        </motion.div>
      </motion.div>
    </AnimatePresence>
