...
const Ofertas = ({ addToCart }) => {
  ...
  if (loading) {
    return (
      <p className="text-center text-gray-600 py-16">Cargando ofertas...</p>
    );
  }
    ...
    <section className="w-full py-16 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-red-50 border border-red-200 rounded-full px-6 py-2 mb-4">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900">
            Descuentos <span className="text-red-600">Imperdibles</span>
          </h2>
        </div>
              ...
              >
                ...
                {producto?.descuento && (
                  <div className="absolute top-3 left-3 z-10">
                    <div className="bg-red-600 text-white font-bold px-3 py-2 rounded-xl shadow-lg">
                ...
                {/* TIMER */}
                <div className="absolute top-3 right-3 z-10 bg-white/90 border border-gray-200 text-gray-700 text-xs font-semibold px-3 py-1 rounded-full flex items-center gap-1 shadow">
                  <Clock size={12} />
                  <span>Últimas unidades</span>
                </div>

                {/* IMAGEN */}
                <div className="relative w-full h-48 sm:h-64 overflow-hidden bg-gray-50">
                  <img
                    src={producto?.imagen}
                    alt={producto?.nombre}
                ...
                <div className="p-4 text-center">
                  <h3 className="text-gray-900 text-sm sm:text-base font-semibold line-clamp-2 mb-3">
                    {producto?.nombre}
                  </h3>
