...
export default function Login() {
  ...
  useEffect(() => {
    ...
    // Verificar si es el programador
    const isDeveloper =
  ...
  // Auto-completar credenciales al seleccionar usuario (solo para desarrollo)
  const handleUserSelect = (userObj) => {
    if (!developerMode) {
      setError("Solo disponible en modo desarrollador");
      return;
    }
  ...
  const handleTestConnection = async () => {
    ...
    if (backendStatus === "online") {
      setError("✅ Conexión con el backend establecida correctamente");
    } else {
      setError("❌ No se pudo conectar con el backend. Verifica la URL.");
    }
  };

  // Función para login rápido de desarrollo (solo en modo desarrollador)
  const handleDevLogin = (username, password) => {
  ...
  // Usuarios de desarrollo (solo visibles en modo desarrollador)
  const devUsers = [
    {
      username: "admin",
      password: "admin123",
    ...
    <div className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-gray-900 via-gray-950 to-black overflow-hidden">
      ...
      <div className="absolute top-4 right-4 z-20">
        <motion.button
          ...
          title="Click para probar conexión"
        >
          {backendStatus === "online" ? (
      ...
      >
        {/* Panel izquierdo: Información y modo desarrollador */}
        <motion.div
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl border border-gray-800 shadow-2xl overflow-hidden h-full">
              ...
              <div className="p-6 space-y-4">
                ...
                <button
                  onClick={handleTestConnection}
                  className="w-full py-2 px-4 bg-gradient-to-r from-gray-800 to-gray-900 border border-gray-700 rounded-xl text-gray-300 hover:text-white hover:border-gray-600 transition-all flex items-center justify-center gap-2"
                >
                ...
                {developerMode && (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      {devUsers.map((userObj) => (
                        <motion.button
                          key={userObj.username}
                          type="button"
                          onClick={() =>
                            handleDevLogin(userObj.username, userObj.password)
                          }
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          className="w-full p-3 rounded-xl transition-all border border-blue-700/30 bg-gradient-to-r from-blue-900/20 to-blue-800/10 hover:from-blue-800/30 hover:to-blue-700/20"
                        >
                          <div className="flex items-center gap-3">
                            <div className="text-xl">{userObj.icon}</div>
              ...
              <div className="p-6 border-t border-gray-800">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-amber-400">bcrypt</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
            ...
            <div className="relative bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl border border-gray-800 shadow-2xl overflow-hidden">
                ...
                <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        {backendStatus === "online"
                          ...
                          : "⚠️ Verifica la conexión con el servidor"}
                      </p>
                    </div>
                  </div>
                  ...
                  <div
                    className={`px-4 py-2 rounded-lg border ${
                      backendStatus === "online"
                        ? "bg-gradient-to-r from-green-900/30 to-green-800/20 border-green-700/30"
              ...
              <form onSubmit={handleLogin} className="p-8 space-y-6">
                  ...
                  {error && (
                    <motion.div
                      ...
                      className={`p-4 rounded-xl border ${
                        error.includes("correctas") || error.includes("Error")
                ...
                <motion.button
                  type="submit"
                  disabled={loading || backendStatus !== "online"}
                  whileHover={{ scale: backendStatus === "online" ? 1.02 : 1 }}
                  whileTap={{ scale: backendStatus === "online" ? 0.98 : 1 }}
                ...
                {/* Información del modo de autenticación */}
                <div className="text-center">
                  <p className="text-gray-500 text-xs">
                    {backendStatus === "online"
                      ? "🔐 Autenticación segura con backend MySQL"
                      : "⚠️ No se puede conectar con el servidor de autenticación"}
                  </p>
                </div>
              ...
              <div className="px-8 py-4 bg-gradient-to-r from-gray-900/50 to-gray-950/50 border-t border-gray-800">
                <p className="text-center text-xs text-gray-500">
                  {developerMode
                    ? "👨‍💻 Modo desarrollador activo • Ctrl+Shift+O para desactivar"
                    : "🔐 Autenticación con backend MySQL • Todos los intentos son registrados"}
                </p>
              </div>
            </div>
          </div>
