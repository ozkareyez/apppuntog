...
export default function PedidosAdmin() {
  ...
  const [sonidoActivo, setSonidoActivo] = useState(true); // Activado por defecto
  ...
  const playNotificationSound = () => {
    ...
    try {
      ...
      if (audioRef.current && audioRef.current.oscillator) {
        const { audioContext, oscillator, gainNode } = audioRef.current;

        // Crear nuevo oscilador para cada sonido
      ...
      if (sonidoActivo) {
        try {
          ...
          beep.volume = 0.3;
          beep.play().catch((e) => console.log("Fallback beep error:", e));
        } catch (e) {
          console.log("Fallback beep también falló:", e);
        }
      }
    }
  };
...
#PuntoG #${pedido.id}`;
  ...
  // Verificar nuevos pedidos CON SONIDO
  ...
  // Cambiar estado con actualización inmediata
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  ...
                  {/* BOTÓN QUE CAMBIA DE COLOR SEGÚN ESTADO */}
                  <button
