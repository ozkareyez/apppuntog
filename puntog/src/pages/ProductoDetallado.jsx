...
//     // Si el producto tiene array de imágenes de Cloudinary
//     if (producto.imagenes && Array.isArray(producto.imagenes)) {
//       return producto.imagenes.map((img) => {
//         // Manejar tanto objetos {url, public_id} como strings
//         if (typeof img === "object" && img.url) {
...
//     // Si tiene el campo imagen (para compatibilidad con datos antiguos)
//     if (producto.imagen) {
//       return [
//         producto.imagen.startsWith("http")
//           ? producto.imagen
//           : `${API_URL}/images/${producto.imagen}`,
//       ];
//     }
...
//       })
//       .then((data) => {
//         // Asegurarnos que tenemos un array de imágenes
...
//                 {/* IMAGE NAVIGATION (solo si hay más de 1 imagen) */}
//                 {images.length > 1 && (
//                   <>
//                     <button
//                       onClick={prevImage}
...
//             >
//               {recomendados.map((p) => {
//                 // Obtener imágenes para producto recomendado
//                 const productoImagenes =
//                   p.imagenes || (p.imagen ? [p.imagen] : []);
//                 const primeraImagen =
//                   productoImagenes.length > 0
//                     ? typeof productoImagenes[0] === "object"
//                       ? productoImagenes[0].url
//                       : productoImagenes[0]
//                     : "/imagenes/no-image.png";
...
//   const carruselRef = useRef(null);
//   const imageGallery = [1, 2, 3]; // Placeholder para múltiples imágenes
